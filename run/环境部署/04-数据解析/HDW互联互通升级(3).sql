...
/*========================================================================*/
 /* DC_MJZBL_JZLGBL_CBZD     门（急）诊病历 — 急诊留观病历_初步诊断                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZCJL_DCJL_SSS     A-标准表 — 助产记录 — 待产记录_手术史                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZCJL_DCJL_JWS     A-标准表 — 助产记录 — 待产记录_既往史                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZCJL_DCJL_JWYCS     A-标准表 — 助产记录 — 待产记录_既往孕产史                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZLCZJL_ZLJL_JBZD     治疗处置记录－治疗记录_疾病诊断                                                                                                 */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_CYJL_FZJC     住院病程记录－出院记录_辅助检查                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_JDXJ_RYZD     住院病程记录－交接班记录_入院诊断                                                                                                */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_JDXJ_MQZD     住院病程记录－交接班记录_目前诊断                                                                                                */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_JJBJL_RYZD     住院病程记录－交接班记录_入院诊断                                                                                                */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_JJBJL_MQZD     住院病程记录－交接班记录_目前诊断                                                                                                */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_SCBCJL_CZZD     住院病程记录－首次病程记录_初步诊断                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_SCBCJL_JZZD    住院病程记录－首次病程记录_鉴别诊断                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_SWBLTLJL_TLRY     住院病程记录－死亡病例讨论记录_参加讨论人员                                                                                           */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_ZKJL_RYZD    住院病程记录－转科记录-入院诊断                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_ZKJL_MQZD    住院病程记录－转科记录-目前诊断                                                                                                 */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZZYJL_ZZYJL_JBZD     转(诊)院记录－转（诊）院记录_疾病诊断                                                                                          */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /*   DC_RYJL_JBXX     A-标准标表 — 入院记录 — 入院记录基本信息                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
where id = object_id('DC_RYJL_JBXX') )
...
/*========================================================================*/
 /* DC_RYJL_JBXX_HYS     A-标准标表 — 入院记录 — 入院记录基本信息_婚育史                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_JZS     A-标准标表 — 入院记录 — 入院记录基本信息_家族史                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_SSS     A-标准标表 — 入院记录 — 入院记录基本信息_手术史                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_QDZYZD     A-标准标表 — 入院记录 — 入院记录基本信息_确定中医诊断                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_QDXYZD     A-标准标表 — 入院记录 — 入院记录基本信息_确定西医诊断                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_FZJCJG     A-标准标表 — 入院记录 — 入院记录基本信息_辅助检查结果                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_GMS     A-标准标表 — 入院记录 — 入院记录基本信息_过敏史                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_CZXYZD     A-标准标表 — 入院记录 — 入院记录基本信息_初步诊断                                                                                                  */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_XZXYZD     A-标准标表 — 入院记录 — 入院记录基本信息_修正诊断                                                                                                 */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_RYJL_JBXX_BZBM     A-标准标表 — 入院记录 — 入院记录基本信息_补充诊断                                                                                                 */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
...
/*========================================================================*/
 /* DC_ZYBCJL_CYJL_CZZYZH     住院病程记录－出院记录_ 出院中医证候                                                                                                */
 /*========================================================================*/
 if not exists 
(select 1 from sysobjects 
