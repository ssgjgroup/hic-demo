USE [HOSPITAL_DW]
GO
/****** Object:  StoredProcedure [dbo].[USP_SPLIT_ZYBCJL_SQXJ]    Script Date: 2018/11/19 9:28:11 ******/
SET ANSI_NULLS ON
GO
 ...
 */
ALTER PROCEDURE [dbo].[USP_SPLIT_ZYBCJL_SQXJ]
...
as
  begin
    ...
    select @yljgdm,
           ltrim(rtrim(a.yjlxh)) + ltrim(rtrim(Str(_0.id))),
           a.yjlxh,
           _0.value,
           1,
           getdate(),
    ...
    select @yljgdm,
           ...
           '0'
    from  #HLHT_ZYBCJL_SQXJ a
            CROSS APPLY (select id, value from [dbo].[fn_com_split_ext](a.sqzdbm, @regex)) _0
            CROSS APPLY (select id, value from [dbo].[fn_com_split_ext](a.sqzdmc, @regex)) _1
    where _0.id = _1.id
    ...
    UPDATE A SET A.STATUS='1' FROM HLHT_ZYBCJL_SQXJ A,#HLHT_ZYBCJL_SQXJ B WHERE A.yjlxh = B.yjlxh
    drop table #HLHT_ZYBCJL_SQXJ
