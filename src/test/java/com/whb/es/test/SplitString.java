...
public class SplitString {
	public static void main(String[] args) {
		...
		String bzds = " xh            |       numeric(12)      _   identity(1 1)/* 序号  */,\n" +
				...
				"    bfmc          |       varchar(10)      _   not null/* 病房名称 */,\n" +
				...
				"    tldddm        |       varchar(20)      _   not null/* 讨论地点代码 */,\n" +
				"    tldd          |       varchar(50)      _   not null/* 讨论地点名称 */,\n" +
				"    zcrbm         |       varchar(100)     _   not null/* 主持人工号 */,\n" +
				"    zcrxm         |       varchar(500)     _   not null/* 主持人姓名 */,\n" +
				"    zjswyymc      |       varchar(128)     _   not null/* 直接死亡原因名称 */,\n" +
				"    zjswyybm      |       varchar(64)      _   not null/* 直接死亡原因编码 */,\n" +
				"    swtljl        |       nvarchar(2000)   _   not null/* 死亡讨论记录 */,\n" +
				"    zcrzjyj       |       nvarchar(2000)   _   not null/* 主持人总结意见 */,\n" +
		...
		String createHlhtTemp = "-- 创建临时表 \n select * into #"+bmz.replace("DC_", "ANMR_") +" from " + bmz.replace("DC_", "ANMR_")+" where STATUS = 0;\n";
