...
public class HlhtZqgzxxSxzltysServiceImpl implements HlhtZqgzxxSxzltysService {
    ...
    public MbzDataCheck interfaceHlhtZqgzxxSxzltys(MbzDataCheck t) {
        ...
        if (hlhtZqgzxxSxzltysList != null) {
            ...
            for (HlhtZqgzxxSxzltys obj : hlhtZqgzxxSxzltysList) {
                ...
                try {
                    ...
                    String log = Constants.WN_ZQGZXX_SXZLTYS_SOURCE_TYPE +"||"+getClass().toString()+"||"+"解析病历报错,病历名称：{"+obj.getBlmc()+"},源记录序号{"+obj.getYjlxh()+"}"+"||错误原因:{"+e.getMessage()+"}";
                ...
                //this.createHlhtZqgzxxSxzltys(obj);
                try {
                    this.createHlhtZqgzxxSxzltys(obj);
                } catch (Exception e) {
                ...
                try {
                    ...
                    String log = Constants.WN_ZQGZXX_SXZLTYS_SOURCE_TYPE +"||"+getClass().toString()+"||"+"病历百分比计算报错,病历名称：{"+obj.getBlmc()+"},源记录序号{"+obj.getYjlxh()+"}"+"||错误原因:{"+e.getMessage()+"}";
                    mbzLogService.createMbzLog(log);
                    continue;
                }
                real_count++;
        ...
        //更新dc表
        t.getMap().put("sourceType", Constants.WN_ZQGZXX_SXZLTYS_SOURCE_TYPE);
