 ...
 * @date 2018-27-14 16:27:51
 */
@Alias("outpJzjlk")
public class OutpJzjlk extends BaseDomain implements Serializable {
     ...
     * 默认值：无
     */
    private String ghysdm;
    /**
     * 字段名：ghysmc
     * 备注: 
     * 默认值：无
     */
    private String ghysmc;
    /**
     * 字段名：ghksdm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String sdysdm;
    /**
     * 字段名：sdysxm
     * 备注: 
     * 默认值：无
     */
    private String sdysxm;
    /**
     * 字段名：scjzysdm
     * 备注: 
     * 默认值：无
     */
    private String scjzysdm;
    /**
     * 字段名：scjzsj
     * 备注: 
     * 默认值：无
     */
    private String scjzsj;
    /**
     * 字段名：jzysdm
     * 备注: 
     * 默认值：无
     ...
     * 默认值：无
     */
    private String dbzddm;
    /**
     * 字段名：dbzdmc
     * 备注: 
     * 默认值：无
     */
    private String dbzdmc;
    /**
     * 字段名：shbzh
     * 备注: 
     * 默认值：无
   ...
   * 备注: 
   */
   public void setGhhx(Integer ghhx){
        this.ghhx = ghhx;
   }
   /**
   * 字段名：yyxh
   ...
   * 备注: 
   */
   public void setCfzbz(Short cfzbz){
        this.cfzbz = cfzbz;
   }
   /**
   * 字段名：ghlb
   ...
   * 备注: 
   */
   public void setPzlx(Integer pzlx){
        this.pzlx = pzlx;
   }
   /**
   * 字段名：zddm
   ...
   * 备注: 
   */
   public void setGhysdm(String ghysdm){
        this.ghysdm = ghysdm;
   }
   /**
   * 字段名：ghysmc
   ...
   * 备注: 
   */
   public void setGhysmc(String ghysmc){
        this.ghysmc = ghysmc;
   }
   /**
   * 字段名：ghksdm
   ...
   * 备注: 
   */
   public void setPzlxsm(String pzlxsm){
        this.pzlxsm = pzlxsm;
   }
   /**
   * 字段名：zhbz
   ...
   * 备注: 
   */
   public void setJzbz(Integer jzbz){
        this.jzbz = jzbz;
   }
   /**
   * 字段名：zjdm
   ...
   * 备注: 
   */
   public void setSdysdm(String sdysdm){
        this.sdysdm = sdysdm;
   }
   /**
   * 字段名：sdysxm
   ...
   * 备注: 
   */
   public void setSdysxm(String sdysxm){
        this.sdysxm = sdysxm;
   }
   /**
   * 字段名：scjzysdm
   ...
   * 备注: 
   */
   public void setScjzysdm(String scjzysdm){
        this.scjzysdm = scjzysdm;
   }
   /**
   * 字段名：scjzsj
   * get方法
   ...
   * 备注: 
   */
   public void setScjzsj(String scjzsj){
        this.scjzsj = scjzsj;
   }
   /**
   * 字段名：jzysdm
   ...
   * 备注: 
   */
   public void setJzysmc(String jzysmc){
        this.jzysmc = jzysmc;
   }
   /**
   * 字段名：jzsj
   ...
   * 备注: 
   */
   public void setJlzt(Short jlzt){
        this.jlzt = jlzt;
   }
   /**
   * 字段名：mzlgbz
   ...
   * 备注: 
   */
   public void setMzlgbz(Integer mzlgbz){
        this.mzlgbz = mzlgbz;
   }
   /**
   * 字段名：memo
   ...
   * 备注: 
   */
   public void setYlxmmc(String ylxmmc){
        this.ylxmmc = ylxmmc;
   }
   /**
   * 字段名：dbzddm
   ...
   * 备注: 
   */
   public void setDbzddm(String dbzddm){
        this.dbzddm = dbzddm;
   }
   /**
   * 字段名：dbzdmc
   ...
   * 备注: 
   */
   public void setDbzdmc(String dbzdmc){
        this.dbzdmc = dbzdmc;
   }
   /**
   * 字段名：shbzh
   ...
   * 备注: 
   */
   public void setLybz(Integer lybz){
        this.lybz = lybz;
   }
   /**
   * 字段名：emrxh
   ...
   * 备注: 
   */
   public void setEmrxh(Long emrxh){
        this.emrxh = emrxh;
   }
   /**
   * 字段名：tsbzdm
   ...
   * 备注: 
   */
   public void setTsbzmc(String tsbzmc){
        this.tsbzmc = tsbzmc;
   }
   /**
   * 字段名：cfjzzt
   ...
   * 备注: 
   */
   public void setCfjzzt(Integer cfjzzt){
        this.cfjzzt = cfjzzt;
   }
   /**
   * 字段名：bmjb
